...
public class Globals {
    ...
    public void setupResources() {
        ...
        resources.addImage("FullHealth", new Image("powerup_life.png"));
        resources.addImage("HalfHealth", new Image("lowHealth.png"));
        resources.addImage("NoHealth", new Image("noHealth.png"));
